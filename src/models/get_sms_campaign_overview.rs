...
pub struct GetSmsCampaignOverview {
...
impl GetSmsCampaignOverview {
    pub fn new(id: i64, name: String, status: Status, content: String, scheduled_at: String, sender: String, created_at: String, modified_at: String) -> GetSmsCampaignOverview {
