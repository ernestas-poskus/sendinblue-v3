...
impl GetAggregatedReport {
    pub fn new(range: String, requests: i64, delivered: i64, hard_bounces: i64, soft_bounces: i64, clicks: i64, unique_clicks: i64, opens: i64, unique_opens: i64, spam_reports: i64, blocked: i64, invalid: i64, unsubscribed: i64) -> GetAggregatedReport {
        GetAggregatedReport {
            range,
            requests,
            delivered,
