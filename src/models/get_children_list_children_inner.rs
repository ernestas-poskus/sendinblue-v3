...
pub struct GetChildrenListChildrenInner {
    /// Login Email
    #[serde(rename = "email")]
    pub email: String,
    /// First Name
...
impl GetChildrenListChildrenInner {
    pub fn new(email: String, first_name: String, last_name: String, company_name: String, password: String) -> GetChildrenListChildrenInner {
