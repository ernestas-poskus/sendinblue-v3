...
/// GetExtendedCampaignStatsGlobalStats : Overall statistics of the campaign



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct GetExtendedCampaignStatsGlobalStats {
...
impl GetExtendedCampaignStatsGlobalStats {
    /// Overall statistics of the campaign
    pub fn new(unique_clicks: i64, clickers: i64, complaints: i64, delivered: i64, sent: i64, soft_bounces: i64, hard_bounces: i64, unique_views: i64, trackable_views: i64, unsubscriptions: i64, viewed: i64) -> GetExtendedCampaignStatsGlobalStats {
