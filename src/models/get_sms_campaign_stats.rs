...
pub struct GetSmsCampaignStats {
...
impl GetSmsCampaignStats {
    pub fn new(delivered: i64, sent: i64, processing: i64, soft_bounces: i64, hard_bounces: i64, unsubscriptions: i64, answered: i64) -> GetSmsCampaignStats {
        GetSmsCampaignStats {
            delivered,
            sent,
            processing,
