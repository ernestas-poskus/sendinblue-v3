...
pub struct GetContactsContactsInner {
...
impl GetContactsContactsInner {
    pub fn new(email: String, id: i64, email_blacklisted: bool, sms_blacklisted: bool, created_at: String, modified_at: String, list_ids: Vec<i64>, attributes: serde_json::Value) -> GetContactsContactsInner {
