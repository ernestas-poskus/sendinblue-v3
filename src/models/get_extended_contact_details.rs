...
pub struct GetExtendedContactDetails {
    ...
    pub statistics: Box<crate::models::GetExtendedContactDetailsAllOfStatistics>,
}

impl GetExtendedContactDetails {
    pub fn new(email: String, id: i64, email_blacklisted: bool, sms_blacklisted: bool, created_at: String, modified_at: String, list_ids: Vec<i64>, attributes: serde_json::Value, statistics: crate::models::GetExtendedContactDetailsAllOfStatistics) -> GetExtendedContactDetails {
