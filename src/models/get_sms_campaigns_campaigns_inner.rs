...
pub struct GetSmsCampaignsCampaignsInner {
    ...
    pub statistics: Box<crate::models::GetSmsCampaignsCampaignsInnerAllOfStatistics>,
}

impl GetSmsCampaignsCampaignsInner {
    pub fn new(id: i64, name: String, status: Status, content: String, scheduled_at: String, sender: String, created_at: String, modified_at: String, recipients: crate::models::GetEmailCampaignsCampaignsInnerAllOfRecipients, statistics: crate::models::GetSmsCampaignsCampaignsInnerAllOfStatistics) -> GetSmsCampaignsCampaignsInner {
