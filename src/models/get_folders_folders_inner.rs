...
pub struct GetFoldersFoldersInner {
    /// ID of the folder
    #[serde(rename = "id")]
    pub id: i64,
    /// Name of the folder
...
impl GetFoldersFoldersInner {
    pub fn new(id: i64, name: String, total_blacklisted: i64, total_subscribers: i64, unique_subscribers: i64) -> GetFoldersFoldersInner {
